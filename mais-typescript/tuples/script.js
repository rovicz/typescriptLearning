...
const produto2 = ["Notebook", 2500]; // agora por padrão, produto2 é uma string e na sequência um number [string, number], sendo assim fixada previamente.
...
function getText(selector) {
    ...
    if (el) {
        return [el, el.innerText]; // o as const torna um dado readonly e infere o tipo de dado mais específico possível.
    }
    else {
        return null;
    }
